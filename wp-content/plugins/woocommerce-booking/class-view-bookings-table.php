 ...
 * 
 * Class for displaying the old bookings view
 *
...
class WAPBK_View_Bookings_Table extends WP_List_Table {
	...
	/**
	 * @var int Total number of bookings
	 */
	public $total_count;

	/**
	 * @var int Total number of bookings from today onwards
	 */
	public $future_count;

	/**
	 * @var int Total number of check-ins today
	 */
	public $today_checkin_count;

	/**
	 * @var int Total number of checkouts today
	 */
	public $today_checkout_count;

	/**
	 * @var int Total Number of bookings awaiting confirmation
	 */
	public $pending_confirmation;
	
	/**
	 * @var int Total number of unpaid bookings
	 */
	public $unpaid;
	
	/**
	 * @var string Total number of Bookings Imported from GCal
	 */
	 ...
	 * 
	 * @return array Current Views available to be displayed
	 * 
	 * @since 1.7.0
	 */
	 ...
	 * 
	 * @return array Columns array with sortable columns set or reset
	 * 
	 * @since 1.7.0
	 */
	 ...
	 * @return string Total Booking Count
	 * 
	 * @since 1.7.0
	 * @globals mixed $wpdb
	 */
	 ...
	 * 
	 * @param mixed $results_array Results Array
	 * @param int $bookings_count Total Booking Count
	 * 
	 * @globals mixed $wpdb
	 * 
	...
	public function column_default( $booking, $column_name ) {
	    ...
	    switch ( $column_name ) {
			...
			case 'actions' :
				$view_order = __( 'View Order', 'woocommerce-booking' );
	 			$value = '<a href="post.php?post='.$booking->ID.'&action=edit">'.$view_order.'</a>';
				break;
