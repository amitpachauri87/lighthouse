...
class Qode_Import
{
    ...
    public function demos_import_list() {
        ...
        $demos = array(
            ...
            'bridgedb242' => array(
                'title' => esc_html__('New Demo 242 - Delivery', 'qode'),
                'rev-sliders' => array('home.zip'),
                'layer-sliders' => array(),
                'required-plugins' => array('js_composer', 'revslider', 'contact-form-7')
            ),
            'bridgedb243' => array(
                'title' => esc_html__('New Demo 243 - Photo App', 'qode'),
                'rev-sliders' => array('slider1.zip'),
                'layer-sliders' => array(),
                'required-plugins' => array('js_composer', 'revslider')
            ),
            'bridgedb244' => array(
                'title' => esc_html__('New Demo 244 - Climbing Club', 'qode'),
                'rev-sliders' => array('home1.zip'),
                'layer-sliders' => array(),
                'required-plugins' => array('js_composer', 'revslider', 'contact-form-7')
            ),
            'bridgedb245' => array(
                'title' => esc_html__('New Demo 245 - Organic Food Store', 'qode'),
                'rev-sliders' => array('home.zip'),
                'layer-sliders' => array(),
                'required-plugins' => array('js_composer', 'revslider', 'contact-form-7', 'woocommerce')
            ),
            'bridgedb246' => array(
                'title' => esc_html__('New Demo 246 - Fitness Tracker', 'qode'),
                'rev-sliders' => array('home.zip'),
                'layer-sliders' => array(),
                'required-plugins' => array('js_composer', 'revslider', 'contact-form-7')
            ),
            'bridgedb247' => array(
                'title' => esc_html__('New Demo 247 - Catering', 'qode'),
                'rev-sliders' => array('home.zip'),
                'layer-sliders' => array(),
                'required-plugins' => array('js_composer', 'revslider', 'contact-form-7')
            ),
            'bridgedb248' => array(
                'title' => esc_html__('New Demo 248 - Chocolate', 'qode'),
                'rev-sliders' => array('home1.zip'),
                'layer-sliders' => array(),
                'required-plugins' => array('js_composer', 'revslider', 'contact-form-7')
            ),
            'bridgedb249' => array(
                'title' => esc_html__('New Demo 249 - Book Landing', 'qode'),
                'rev-sliders' => array('home1.zip'),
                'layer-sliders' => array(),
                'required-plugins' => array('js_composer', 'revslider', 'contact-form-7')
            ),
            'bridgedb250' => array(
                'title' => esc_html__('New Demo 250 - Nursing Home', 'qode'),
                'rev-sliders' => array(),
                'layer-sliders' => array(),
                'required-plugins' => array('js_composer', 'contact-form-7')
            ),
