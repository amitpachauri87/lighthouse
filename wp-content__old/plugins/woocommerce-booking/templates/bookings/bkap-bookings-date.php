    ...
    ?>
    	...
    	<div class="bkap_start_date" id="bkap_start_date">
    		<label class="book_start_date_label" style="margin-top:1em;">
    			<?php 
                    $bkap_start_date_label = __( ( '' !== get_option( "book_date-label" ) ? get_option( "book_date-label" ): 'Start Date' ) , "woocommerce-booking" ); 
                                    
                    $bkap_start_date_label = apply_filters( 'bkap_change_start_date_label', $bkap_start_date_label, $booking_settings);
