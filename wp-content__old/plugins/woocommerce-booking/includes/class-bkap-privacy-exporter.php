...
if ( !class_exists('bkap_Personal_Data_Export' ) ) {
    ...
    class Bkap_Personal_Data_Export {
        ...
        static function get_booking_data( $booking_id ) {
            ...
            $booking_details_to_export = apply_filters( 'bkap_personal_booking_details_prop',
            										 array( 'booking_id'		=> __( 'Booking ID', 		'woocommerce-booking' ),
        ...
        static function get_gcal_event_data( $google_id ) {
            ...
            $google_details_to_export = apply_filters( 'bkap_personal_export_google_events_prop',
            										 array( 'gcal_id'			=> __( 'Google Event ID', 			'woocommerce-booking' ),
