        ...
        <div class="feature-section clearfix">
            <div class="content feature-section-item">
                ...
                <h3><?php esc_html_e( 'Different delivery settings for each weekday', 'order-delivery-date-lite' ); ?></h3>
                    ...
                    <a href="https://www.tychesoftwares.com/weekday-settings/?utm_source=wpaboutpage&utm_medium=link&utm_campaign=OrderDeliveryDateProPlugin" target="_blank" class="button-secondary">
                        <?php esc_html_e( 'Learn More', 'order-delivery-date-lite' ); ?>
                        <span class="dashicons dashicons-external"></span>
                    </a>
            </div>
