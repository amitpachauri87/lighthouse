 ...
 *
 * Displaying Booking Details Metabox on the Edit Booking Post page
 *
 * @author   Tyche Softwares
 * @package  BKAP/Bookings
 * @todo     Depricated so varify it once and remove it.
 */
?>

<div>
    <h2><?php echo __( 'Edit Booking', 'woocommerce-booking' ); ?></h2>
</div>
<?php 
global $wpdb;
