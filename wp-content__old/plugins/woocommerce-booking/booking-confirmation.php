...
if ( ! class_exists( 'bkap_booking_confirmation' ) ) {
    ...
    class bkap_booking_confirmation {
        ...
        public function __construct() {
            ...
            // Happens only if the booking requires confirmation and the order contains multiple bookings which require confirmation
         ...
         * @param int $product_id - product ID
         * @return array $booking_settings - Updated settings
         * 
         * @hook bkap_save_product_settings
         * @since 2.5
         */
		 ...
		 * @param integer item_id - Item ID
		 * @param WC_Product_Item item_value $item_value - Item Details
