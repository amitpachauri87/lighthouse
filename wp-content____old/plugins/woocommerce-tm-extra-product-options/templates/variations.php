			...
			if ( is_array( $options ) ) {
				...
				if ( taxonomy_exists( $att_id ) ) {
					...
					foreach ( $terms as $term ) {
						...
						if(isset($variations_options[$att_id]) && isset($variations_options[$att_id]['variations_image']) && !empty($variations_options[$att_id]['variations_imagep'][$term->slug])){
					...
					foreach ( $options as $option ) {
						...
						if(isset($variations_options[$att_id]) && isset($variations_options[$att_id]['variations_image']) && !empty($variations_options[$att_id]['variations_imagep'][$option])){
					...
					case 'select':
						if (class_exists('TM_EPO_FIELDS_select')){
							...
							if (is_array($display)){
								...
								$variations_builder_element_start_args["class_id"] = "variation-element-".$loop;
								wc_get_template(
