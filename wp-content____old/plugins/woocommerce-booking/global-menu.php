...
class global_menu {
    ...
    */
    ...
    public static function bkap_woocommerce_booking_admin_menu(){
    	...
    	$page = add_submenu_page(   null,
                                    __( 'View Bookings', 'woocommerce-booking' ),
                                    __( 'View Bookings', 'woocommerce-booking' ),
                                    'manage_woocommerce',
                                    'woocommerce_history_page',
                                    array( 'view_bookings', 'bkap_woocommerce_history_page' ) 
                                );

    	$page = add_submenu_page(  'edit.php?post_type=bkap_booking', 
    	...
    	$page = add_submenu_page(   'edit.php?post_type=bkap_booking', 
                                    ...
                                    array( 'bkap_license', 'bkap_get_edd_sample_license_page' ) 
                                );
