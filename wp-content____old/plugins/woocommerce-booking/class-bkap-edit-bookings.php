    ...
    class bkap_edit_bookings_class
    {
        ...
        public function bkap_add_edit_link( $product_title, $cart_item, $cart_item_key ) {
            ...
            if ( ( ( is_cart() && !is_ajax() ) || is_checkout() ) && !is_product() && 
                ...
                $edit_booking_str = __( "Edit Booking", "woocommerce-booking" );

                if ( strpos( $product_title, "<a href" ) !== false ) {

                    printf( '<a href="%s">%s</a><div style="clear:both;"></div><input type="button" class="bkap_edit_bookings" onclick=bkap_edit_booking_class.bkap_edit_bookings(%d,"%s") value="%s">',
                    ...
                    $product_title .= sprintf( '<input type="button" class="bkap_edit_bookings" onclick=bkap_edit_booking_class.bkap_edit_bookings(%d,"%s") value="%s">', $product_id, $cart_item_key, $edit_booking_str );                    
                }
        ...
        public static function bkap_update_item_bookings( $order_id, $item_id, $old_start, $old_end, $old_time, $product_id, $booking_data, $booking_id, $quantity, $old_resource, $page = '' ) {
            ...
            bkap_checkout::bkap_update_lockout( $order_id, $product_id, '', $quantity, $booking_data, $page );
            ...
            bkap_insert_event_to_gcal( $order_obj, $product_id, $item_id ); 
        }
