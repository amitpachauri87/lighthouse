/**
 * File for all JS actions related to Update Process
 * @namespace bkap_update
 * @since 4.0.0
 */

/**
 * Function when 4.0.0 Update button is clicked
 *
...
/**
 * Update when first update button is clicked
 *
 * @fires event:click
 * @since 4.0.0
 */
...
/**
 * Update database if step 2 is clicked
 *
 * @fires event:click
 * @since 4.1.0
 */
