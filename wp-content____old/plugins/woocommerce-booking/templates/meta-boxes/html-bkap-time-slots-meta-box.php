        ...
        foreach ( $bkap_weekday_value as $day_key => $time_data  ) {
    		...
    		?>
			    ...
			    <tr id="bkap_date_time_row_<?php echo $number;?>">
			        ...
			        <td width="10%"><input id="bkap_lockout_time_<?php echo $number;?>" type="number" name="quantity" style="width:100%;" min="0" placeholder="Max bookings" value="<?php echo $bkap_lockout;?>" class = "bkap_default" ></td>
