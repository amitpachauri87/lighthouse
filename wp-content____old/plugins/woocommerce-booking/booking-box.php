        ...
        <div id='bkap-tabbed-nav'>
            ...
            <div>
                ...
                <div id="booking_options">
                    ...
                    <?php do_action( 'bkap_before_purchase_without_date', $duplicate_of ); ?>
                ...
                <div id="booking_settings" style="display:none;">
                    ...
                    <table class="form-table">
                        ...
                        <?php do_action( 'bkap_before_minimum_days', $duplicate_of ); ?>
                        ...
                        <?php do_action( 'bkap_before_number_of_dates', $duplicate_of ); ?>
                        ...
                        <?php do_action( 'bkap_after_lockout_date', $duplicate_of ); ?>
                        ...
                        <?php do_action( 'bkap_after_minimum_days_multiple', $duplicate_of ); ?>
                        ...
                        <?php do_action( 'bkap_after_maximum_days_multiple', $duplicate_of ); ?>
                ...
                <?php do_action( 'bkap_after_listing_enabled', $duplicate_of ); ?>
    ...
    static function bkap_get_weekdays_html( $product_id, $lockout = false, $price = true, $booking_settings = array() ) {
        ...
        static function bkap_get_daydate_and_time_table_base_data( $product_id, $booking_settings ){
            ...
            <tr id="bkap_default_date_time_row" style="display: none;">
                ...
                <td width="10%"><input id="bkap_lockout_time" type="number" name="quantity" style="width:100%;" min="0" placeholder="Max bookings"></td>
    ...
    function delete_booking_history( $product_id, $day_value, $from_time = '', $to_time = '' ) {
        ...
        if ( isset( $day_value ) && substr( $day_value, 0, 7 ) == 'booking' ) { // recurring weekday
            ...
            $delete_base = "DELETE FROM `" . $wpdb->prefix . "booking_history`
                            ...
                            AND to_time = '" . $to_time . "'";
            $delete_base = $wpdb->query( $delete_base );
