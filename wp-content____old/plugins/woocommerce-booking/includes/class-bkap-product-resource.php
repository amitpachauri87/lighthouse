...
class Class_Bkap_Product_Resource {
    ...
    public function __construct( $product_id = 0 ) {
        ...
        add_filter( 'woocommerce_loop_add_to_cart_link',    array( &$this, 'woocommerce_loop_add_to_cart_link_callback' ), 99, 3 );
    }

    /**
     * This function is to change the href link of Add to cart button on Shop page
     * 
     * @param string $link - DATA in $_POST
    ...
    function woocommerce_product_add_to_cart_url_callback( $link, $product ) {
     ...
     * 
     * @param string $link - DATA in $_POST
     * @param Object $this_p - WP Post Product
     * @return string $link - href attribute value
     * 
     * @hook woocommerce_product_add_to_cart_url
     * @since 4.8.0
    ...
    function woocommerce_loop_add_to_cart_link_callback( $link, $product, $args ){
        ...
        $args['class']  = str_replace( $ajax_class, "", $class );
        $button_text    = __( "Select Resource", "woocommerce-booking" );

        $button_text    = apply_filters( 'bkap_change_select_resource_text', $button_text );
    ...
    public static function bkap_get_extra_options(){
        ...
        return apply_filters( 'bkap_extra_options', array(
            ...
            'bkap_resource' => array(
                ...
                'description'   => __( 'Resource is your objects (like rooms, cars or tables) or services, what can be booked by visitors of your sites.', 'woocommerce-booking' ),
                'default'       => 'no',
            ),
        ) );
    }
	 ...
	 *
	 * @param array $booking_settings - Booking Setting Array
	 * @param integer $product_id - Product ID
	 * @return array $booking_settings - Booking Settings
	 * 
	 * @since 4.6.0
	 */
