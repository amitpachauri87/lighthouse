...
class Custom_WooCommerce_Widget_Product_Search extends WP_Widget {
	 ...
	 * @access public
	 * @since 1.7
	 * @param array $page_name Name of the page
	 * @global mixed $wpdb Global wpdb object
	 * @return string $page_permalink Permalink of the given page
	 */
	...
	function widget( $args, $instance ) {
		...
		if( $category_value != 'disable' ){
		    ...
		    $all_categories = __( "All categories","woocommerce-booking" );

		    $contents = "<select id='cat' name='select_cat'><option value = '0'>".$all_categories."</option>";
	    ...
	    wp_enqueue_style( 'jquery-ui', plugins_url( "/woocommerce-booking/css/themes/$calendar_theme_sel/jquery-ui.css" ) ,'', $plugin_version_number, false );
